...
def recover_historical_domain(raw_output: str | bytes | dict[str, Any], *, allowed_scope_ids: set[str] | None = None, evidence_key_map: dict[str, str] | None = None):
    wire, diagnostics = recover_historical_wire(raw_output)
    return wire_to_domain(wire, allowed_scope_ids=allowed_scope_ids, evidence_key_map=evidence_key_map), diagnostics
