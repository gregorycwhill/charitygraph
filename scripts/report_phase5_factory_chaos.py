...
def main() -> int:
 ...
 report={'network_calls':0,'provider_calls':0,'semantic_knowledge_production':0,'scenario_ledger':scenario_ledger(attempts),'task_states':tasks,'physical_states':physical,'sqlite_integrity':integrity,'foreign_key_violations':foreign}
