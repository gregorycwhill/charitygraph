...
def main() -> int:
    ...
    try:
        ...
        prior_parameters = {"max_output_tokens": MAX_OUTPUT_TOKENS, "reasoning": "high", "scope_ids": [x["scope_id"] for x in scopes], "schema_transport_revision": "empty-enum-omitted-v2"}
