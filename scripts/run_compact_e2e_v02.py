...
PROMPT="""Extract evidence-supported Compact Knowledge v0.2 atoms ABOUT THE DECLARED TARGET SUBJECT in the packet. Target relevance and scope are independent: subject is organisation-wide target knowledge; named_program_or_service requires one evidenced named instance of a target program/service/project/campaign (generic plural categories such as literacy programs, aged-care services or fundraising activities remain subject scope); other_named_scope is one single named subordinate scope; reporting_group is an evidenced formal consolidation group of the target; uncertain is allowed when target relevance is clear but scope is not. Never concatenate distinct names into a synthetic scope or append labels such as program/service/sponsorship. Do not emit standalone facts about unrelated organisations, regulators, investigations or legal instruments. Preserve ordinary first-party identity/activity/geography facts without unnecessary claims wording, but retain source attribution for impact, outcomes, effectiveness, causal or evaluative claims. Exact effective_from/effective_to require an evidenced calendar day; year-only or coarse phrases stay null and may use reporting_period, never manufactured dates. Do not invent a reporting period for an undated current figure. Use explicit_absence only for evidenced absence/none/zero; pending or not-yet-submitted states are supported status propositions. Preserve source-native relationship strength and do not upgrade beneficiary to serves, listing to operates, classification to delivery, or business name to program. Split coordinated claims only when independently governable; retain genuinely shared-predicate lists. Populate time only when the evidence establishes the association. Include packet-local evidence locators and qualifications. Do not use North-Star sections, taxonomies, card completeness, opaque IDs or outside knowledge. Sparse output is correct."""
