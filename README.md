...
Read [ARCHITECTURE.md](ARCHITECTURE.md) and [AGENTS.md](AGENTS.md) first. Shared product authority, current state and public-contract documentation live in the sibling Data repository.

The active CLI is charitygraph. The literal causebase command remains an isolated warning-emitting compatibility alias. New configuration uses CHARITYGRAPH_ARCHIVE_ROOT, CHARITYGRAPH_RUNTIME_ROOT and CHARITYGRAPH_DATA_REPOSITORY.
