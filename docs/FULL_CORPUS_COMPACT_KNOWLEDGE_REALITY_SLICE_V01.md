...
one request per shard), the completed dry-run projects USD 0.131105, within the
approved USD 0.15 cap. No evidence-bearing provider calls were made and no
coverage was silently reduced.
